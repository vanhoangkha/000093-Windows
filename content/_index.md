---
title : "Windows On AWS - Amazon WorkSpaces"
date :  "`r Sys.Date()`" 
weight : 1 
chapter : false
---
...
3. [Deploy Amazon WorkSpaces](3-deploy-amazon-workspaces/)
4. [Access To Amazon WorkSpaces](4-access-to-amazon-workspaces/)
5. [Clean Up Services](5-clean-up-services/)